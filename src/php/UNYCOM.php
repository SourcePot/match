...
final class UNYCOM{
    ...
    private const REGIONAL_CODES=[
        ...
        'WX'=>'EURASIAN PATENT ORGANIZATION (EAPO)',
        ...
        'WX'=>'INTERNATIONAL BUREAU OF THE WORLD INTELLECTUAL PROPERTY ORGANIZATION (WIPO)',
    ...
    private const CASE_TYPE=[
        'XF'=>'Third party patent family',
        'MF'=>'Tradmark family',
        'E'=>'Invention',
        'F'=>'Patent family',
        'P'=>'Patent case',
    ...
    public const UNYCOM_REGEX='/(([A-Z]{3,5}[ ]{0,1}[0-9\-abPCFS]{0,3} [\-\–\—] ){0,1})([0-9]{4})([ ]{0,1}[A-Z]{1,2})([0-9]{5})([A-Z ]{0,5})([0-9]{0,2})([^0-9]{1}|$)/u';
    ...
    private function parse(string $case):array
    {
        ...
        $unycom['Year']=$match[1];
        $unycom['Type']=$match[2];
        $unycom['Type (long)']=self::CASE_TYPE[$unycom['Type']]??'';
